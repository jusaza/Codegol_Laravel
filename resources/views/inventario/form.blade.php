        ...
        <div class="Formgrupo">
            ...
            <input type="number" name="cantidad_total" class="form-control @error('cantidad_total') is-invalid @enderror" value="{{ old('cantidad_total', $inventario?->cantidad_total) }}" id="cantidad_total" placeholder="Cantidad Total" min = "0" max = "15000" required>
        </div>
        <div class="Formgrupo">
