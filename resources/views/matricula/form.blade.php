<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="hidden" name="fecha_matricula" class="form-control @error('fecha_matricula') is-invalid @enderror" value="{{ old('fecha_matricula', $matricula?->fecha_matricula) }}" id="fecha_matricula" placeholder="Fecha Matricula">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_inicio" class="form-control @error('fecha_inicio') is-invalid @enderror" value="{{ old('fecha_inicio', $matricula?->fecha_inicio) }}" id="fecha_inicio" placeholder="Fecha Inicio">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="categoria" class="form-control @error('categoria') is-invalid @enderror" value="{{ old('categoria', $matricula?->categoria) }}" id="categoria" placeholder="Categoria">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nivel" class="form-control @error('nivel') is-invalid @enderror" value="{{ old('nivel', $matricula?->nivel) }}" id="nivel" placeholder="Nivel">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_jugador" class="form-control @error('id_jugador') is-invalid @enderror" value="{{ old('id_jugador', $matricula?->id_jugador) }}" id="id_jugador" placeholder="Id Jugador">
            {!! $errors->first('id_jugador', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="id_usuario" class="form-label">{{ __('Id Usuario') }}</label>
            <input type="text" name="id_usuario" class="form-control @error('id_usuario') is-invalid @enderror" value="{{ old('id_usuario', $matricula?->id_usuario) }}" id="id_usuario" placeholder="Id Usuario">
