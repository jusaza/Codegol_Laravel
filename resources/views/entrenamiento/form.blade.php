<div>
        <div>
            ...
            <input type="text" name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" value="{{ old('descripcion', $entrenamiento?->descripcion) }}" id="descripcion" placeholder="Ingrese la Descripción" required>
        </div>
        <div class="Formgrupo">
            <label for="fecha" class="form-label">{{ __('Fecha') }}</label>
            <input type="date" name="fecha" class="form-control @error('fecha') is-invalid @enderror" value="{{ old('fecha', $entrenamiento?->fecha) }}" id="fecha" placeholder="Ingrese la fecha" required>

        </div>
        <div class="Formgrupo">
            <label for="hora_inicio" class="form-label">{{ __('Hora Inicio') }}</label>
            <input type="time" name="hora_inicio" class="form-control @error('hora_inicio') is-invalid @enderror" value="{{ old('hora_inicio', $entrenamiento?->hora_inicio) }}" id="hora_inicio" placeholder="Ingrese la hora de inicio" required>
        </div>
        <div class="Formgrupo">
            <label for="hora_fin" class="form-label">{{ __('Hora Fin') }}</label>
            <input type="time" name="hora_fin" class="form-control @error('hora_fin') is-invalid @enderror" value="{{ old('hora_fin', $entrenamiento?->hora_fin) }}" id="hora_fin" placeholder="Ingrese la hora de fin" required>
        </div>
        <div class="Formgrupo">
